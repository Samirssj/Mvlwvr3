            ...
            <div className="space-y-1">
              ...
              {isMobile ? (
                <p className="text-sm leading-relaxed" style={{ color: "#0040ff" }}>
                  Las peliculas son tridas de un servidos externo que con tiene anuncios te recomiendo hacer esto en tu movil, Ve a tus ajustes y busca DNS privado en la opcion que permite escribir segun el movil que tengas escribes esto (<span className="font-semibold" style={{ color: "#ff1a1a" }}>dns.adguard.com</span>) y sales esto bloqueara los anuncios en general de tu movil
                </p>
              ) : (
                <p className="text-sm leading-relaxed" style={{ color: "#0040ff" }}>
